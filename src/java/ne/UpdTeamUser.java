...
@WebServlet(name = "UpdTeamUser", urlPatterns = {"/UpdTeamUser"})
public class UpdTeamUser extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            resultado = db.ejecutarFuncionString("f_registra_equipo_jugadores('" + json + "')");
            db.cerrar();
